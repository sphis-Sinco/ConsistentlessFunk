...
{
	public static var funkinVersion:String = '0.5.1'; // Emulation

	public static var psychEngineVersion:String = '1.0 (modified)'; // Base
	public static var pSliceVersion:String = '2.1'; // Secondary Base

	public static var sincoVersion:String = '1.0';  // Current
