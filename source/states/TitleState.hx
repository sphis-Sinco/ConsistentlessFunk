...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		if (ClientPrefs.data.checkForUpdates && !closedState)
		{
			...
			var http = new haxe.Http("https://raw.githubusercontent.com/sphis-Sinco/SincoEngine/refs/heads/master/gitVersion.txt");

			http.onData = function(data:String)
			{
				updateVersion = data.split('\n')[0].trim();
				var curVersion:String = MainMenuState.sincoVersion.trim();
		...
		if (!closedState)
		{
			...
			switch (sickBeats)
			{
				case 1:
					...
					FlxG.sound.music.fadeIn(4, 0, 0.7);
				case 2:
					createCoolText(['Funkin Crew Inc', 'Shadow Mario', 'mikolka9144', 'Sinco']);
				case 4:
					addMoreText('present');
				case 5:
					deleteCoolText();
